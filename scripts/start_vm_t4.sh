#!/usr/bin/env bash
#
# Variante T4 de start_vm.sh: usa n1-standard-4 + Tesla T4 en vez de
# g2-standard-4 + L4. Más barato y, sobre todo, otra familia de GPU
# → distinta reserva de capacidad cuando europe-west4 se queda sin L4.
#
# El disco persistente (huc-tfm-pilot-vm) es compatible: PyTorch 2.5.1 +
# CUDA 12.4 funcionan en T4 (compute capability 7.5, sm_75).
#
